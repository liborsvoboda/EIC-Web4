...
import { renderAsync as e } from "docx-preview";
var t = {
...
var n = {
  ...
  render: function render(n, r) {
    ...
    if (!n) return r.innerHTML = "", Promise.resolve();
    var s;
    return n instanceof Blob ? s = n : n instanceof Response ? s = n.blob() : n instanceof ArrayBuffer && (s = new Blob([n])), e(s, r, r, _objectSpread(_objectSpread({}, t), i));
  },
  getBlob: function () {
    var _getBlob = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
      var t;
...
function _r() {
  _r = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(e, t) {
...
var i = /*#__PURE__*/function () {
  function i(e) {
    ...
    this.container = e, this.options = t, this.requestOptions = n, this.createWrapper();
  }
  return _createClass(i, [{
    ...
    value: function preview(e) {
      ...
      return new Promise(function (t, r) {
        n.getData(e, _this.requestOptions).then( /*#__PURE__*/function () {
            ...
            return _regeneratorRuntime().wrap(function _callee2$(_context2) {
              while (1) switch (_context2.prev = _context2.next) {
                case 0:
                  ...
                  return n.getBlob(e);
                case 2:
                  _this.fileData = _context2.sent;
                  n.render(_this.fileData, _this.wrapperMain, _this.options).then(function () {
                    t();
                  })["catch"](function (e) {
                    n.render("", _this.wrapperMain, _this.options), r(e);
                  });
                case 4:
                case "end":
    ...
    value: function save(e) {
      r(e || "js-preview-docx-".concat(new Date().getTime(), ".docx"), this.fileData);
    }
  }, {
    key: "destroy",
